    ...
    for kk in range(343):
        ...
        for path, img, im0s, vid_cap, frame, nframes in dataset:
            ...
            for i, det in enumerate(pred):  # detections for image i
                ...
                with open('outputs/1/redlight1.txt', 'a') as file:
                    file.write(str(kk) + ': ')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='outputs/1/', help='output folder')  # output folder
